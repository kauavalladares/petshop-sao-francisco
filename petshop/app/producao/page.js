...
export default function ProducaoLoginPage() {
  ...
  async function entrar(e) {
    ...
    try {
      const resp = await fetch('/api/producao/login', {
        method: 'POST',
  ...
  return (
    <div className="mx-auto max-w-sm px-4 py-24">
      ...
      <h1 className="font-display text-3xl text-teal-900 text-center mb-8">Controle de produção</h1>
