      ...
      <section className="mx-auto max-w-6xl px-4 md:px-6 pt-12 md:pt-20 pb-16">
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          <div className="relative flex justify-center md:justify-end">
            <div className="bg-white rounded-xl2 shadow-soft p-4 md:p-5 rotate-1 max-w-xs w-full">
              <div className="overflow-hidden rounded-xl2">
                <Image
                  src="/images/mascote.jpeg"
                  alt="Cachorro da raça husky siberiano, cliente da petshop"
                  width={800}
                  height={932}
              ...
              <p className="font-display text-teal-900 text-xl mt-4 px-1 pb-1">
